...
//import api.UsersFunctions as UserFunction
...
// Kirim Endpoint
def response = UsersFunctions.getListUsers(page)
...
UsersFunctions.validateGetListUsersBody(response)

println "Validasi untuk GET Users pada page ${page} berhasil."
